...
<center>
	...
	<form id="myform" action="/CargaHorariosOld" method="post">
		...
		<table width="600px" class="contenedor" cellspacing="0"
			...
			<tr>
				<td width="55%">
						...
						<ul class="posicionMiga">
							...
							<li class="menuMiga">
								<span class="separacionMiga">-</span>
									<span class="tituloMiga">Mantenimiento de Horarios</span>
								</li>
						</ul>
					</table>
					<!-- Fin Miga -->
					...
					<br>
					<div class="aviso">
							<span>Al modificar el estado de los Horarios estos pueden quedar inhabilitados para nuevas solicitudes.</span>
					</div>
					<br>
					<br>
					<div align=center>
						<fieldset class="moduloHorarios">
							<legend class="Títulotabla"><span class="tituloMiga"> Horarios </span></legend>
							...
							<td><br />
								<div align="right">
									<input type="button" class="botonCandidato" id="idAgregar"
										value="Agregar Horario" name="Agregar Horario"
			...
			<tr>
				<td>
					<div id="idNuevoHorario" align="center" style="display: none">
							<legend class="Títulotabla"><span class="tituloMiga"> Nuevo Horario</span></legend>
							<table width="%" border="0" cellpadding="2" cellspacing="2"
								class="tablah">
								<thead>
									<tr class="tituloModulo tx1Tabla">
			...
			<tr>
				<td>
					...
					<table width="83%" cellpadding="0" cellspacing="0">
						<tr>
							<td>
								<div id="idNuevoHorariobotones" align="center"
									style="display: none">
									<br />
