...
var pathToImages = '../config/images/';
...
var selectBoxHighlightColor = '#F8981D';
...
function positionCalendar(inputObj){
	calendarDiv.style.left = (document.body.clientWidth/2.5) + 'px';
	calendarDiv.style.top = (document.body.clientHeight/2.5) + 'px';
	if(iframeObj){
