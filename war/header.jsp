...
if(!bNuevaSolicitud) {
	int iAnioSol = Integer.parseInt(sFechaSolicitud.substring(0,4));
	int iMesSol = Integer.parseInt(sFechaSolicitud.substring(5,7));
	int iDiaSol = Integer.parseInt(sFechaSolicitud.substring(8,10)); 
...
if(!sFechaAplicacion.equals("")) {
	int iAnioAp = Integer.parseInt(sFechaAplicacion.substring(0,4));
	int iMesAp = Integer.parseInt(sFechaAplicacion.substring(5,7));
	int iDiaAp = Integer.parseInt(sFechaAplicacion.substring(8,10));
		...
		<div class="menuPrincipal">
				<ul class="home">
					...
					<li class="menu adm centro">
						...
						<ul class="subMenuAdministracion">	
							...
							<li class="subMenu"><a href="/CargaHorariosOld">
								<span class="iconoSubMenuAdm imgAdministracionSubMenu"></span>
								<span class="textoSubMenu">Horarios</span>
							</a></li>
