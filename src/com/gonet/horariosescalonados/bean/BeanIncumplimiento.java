...
@PersistenceCapable (catalog = "horariosescalonadosv2", table = "Incumplimiento")
public class BeanIncumplimiento {
	...
	public BeanIncumplimiento(){
		super();
	}

	
	public BeanIncumplimiento(String strUsuario, String strNoCyge, String strNombre, String strDireccionGeneral,
			String strDireccionCorporativa, String strArea, Date strFecha, String strMes, String strQuincena,
			String strEntradaOficial, String strEntradaReal, String strSalidaReal, String strJornada,
			String strEstancia, String strEdificio, String strAutorizador, String strProveedor, String strProyecto,
			String strEstatus, String strEdificioAsignado) {
		super();
		...
		this.strEntradaReal = (strEntradaReal == null)?HeConstantes.DATO_INVALIDO_REPORTE:strEntradaReal;
		this.strSalidaReal = (strSalidaReal == null)?HeConstantes.DATO_INVALIDO_REPORTE:strSalidaReal;
		this.strJornada = strJornada;
		this.strEstancia = (strEstancia == null)?HeConstantes.DATO_INVALIDO_REPORTE:strEstancia;
	...
	public BeanIncumplimiento(ResultSet resultSet) throws SQLException{
		...
		this.strFecha = resultSet.getDate("fecha");
	...
	public BeanIncumplimiento(Object[] arrobj)
	{
	...
	public BeanIncumplimiento(BeanCumplimientoExternoCyge cumplimientoExterno){
		this.strUsuario = cumplimientoExterno.getStrUsuario();
		this.strNoCyge= cumplimientoExterno.getStrNoCyge();
		this.strNombre=cumplimientoExterno.getStrNombre();
		this.strDireccionGeneral = cumplimientoExterno.getStrDireccionGeneral();
		this.strDireccionCorporativa = cumplimientoExterno.getStrDireccionCorporativa();
		this.strArea=cumplimientoExterno.getStrArea();
		this.strFecha= cumplimientoExterno.getStrFecha();
		this.strMes=cumplimientoExterno.getStrMes();
		this.strQuincena=cumplimientoExterno.getStrQuincena();
		this.strEntradaOficial= cumplimientoExterno.getStrEntradaOficial();
		this.strEntradaReal=cumplimientoExterno.getStrEntradaReal();
		this.strSalidaReal=cumplimientoExterno.getStrSalidaReal();
		this.strJornada=cumplimientoExterno.getStrJornada();
		this.strEstancia=cumplimientoExterno.getStrEstancia();
		this.strEdificio=cumplimientoExterno.getStrEdificio();
		this.strAutorizador=cumplimientoExterno.getStrAutorizador();
		this.strProveedor=cumplimientoExterno.getStrProveedor();
		this.strProyecto=cumplimientoExterno.getStrProyecto();
		this.strEstatus=cumplimientoExterno.getStrEstatus();
		this.strEdificioAsignado=cumplimientoExterno.getStrEdificioAsignado();
	}
	...
	public void setStrSalidaReal(String strSalidaReal) {
		if (strSalidaReal == null)
		{
			this.strSalidaReal = HeConstantes.DATO_INVALIDO_REPORTE;
		}
		else
		{
