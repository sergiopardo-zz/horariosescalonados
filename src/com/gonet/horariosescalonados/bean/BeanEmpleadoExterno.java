...
@PersistenceCapable (catalog = "horariosescalonadosv2", table = "empleadoExterno")
public class BeanEmpleadoExterno implements Archivo{
			...
			public BeanEmpleadoExterno(Object []arrayArchivo){
			...
			public BeanEmpleadoExterno(String noCyge, String usuario, String nombre, String apePaterno, String apeMaterno,
			...
			public BeanEmpleadoExterno(ResultSet resultSet) throws SQLException{
