...
public class UploadEntradaSalidaServlet extends HttpServlet{
	...
	public void doPost(HttpServletRequest req, HttpServletResponse resp) throws IOException, ServletException{
		...
		if(blobKeys == null && blobKeys.isEmpty()){
			...
			String html = cargaMasiva.cargaEntradaSalida(blobKeys, resp);			
			String fileName = "logEntradaSalida_"+ObtenFechas.fechaHoy()+".txt";
